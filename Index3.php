...
🆔 @Dandeeh5';//آیدی کانال بدون @
	...
	if( ($username == "Dr_Hesam" || $username == "Bogifa")  ){
		...
		if($type === 1){
			...
			$url .= '&text=' . urlencode("سلام کاربر گرامی 
			 این یک ربات شخصی میباشد که کار آن برداشتن آیدی پست های فورواردی از کانال های دیگه و جایگزینی ایدی کانال خودو ارسال خودکار آن به کانال هستش
			 جهت داشتن رباتی با این مشخصات با @Dandeh5_bot در ارتباط باشید 
			 قیمت آن پنج هزار تومن میباشد") ;
