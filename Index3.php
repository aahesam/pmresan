...
file_put_contents("gif.txt",$Data1 );
	...
	$channel_id = '@Dandeeh5';//آیدی کانال با @
	$label = '🆔 @Dandeeh5
🆔 @Dandeeh5';//آیدی کانال بدون @
	...
	if( ($username == "Dr_Hesam" || $username == "Bogifa")  ){
		...
		if($type === 1){
			...
			$url .= '&text=' . urlencode("فقط از متن ، عکس ، فیلم ، فایل ، صدا و موسیقی پشتیبانی می شود ") ;
			...
			$url .= '&text=' . urlencode("این یک ربات شخصی است که مطالب ارسالی از کانال های دیگه رو با جایگذاری ایدی کانال شما به صورت خودکار به کانالتان ارسال میکند لذا شما دسترسی لازم به این ربات را ندارید. ✅ \nدرصورتی که تمایل به داشتن همچین رباتی هستید به @Dandeh5_bot پیام خود را ارسال کنید قیمت پنج هزار تومن به صورت ماهیانه میباشد") ;
...
/*
در لاین 43 آیدی دقیق خودتون رو بدون @ جایگزین کنید
