...
این سورس در GraphNews@ و به وسیله Telewram@ نوشته شده است
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
*/
ob_start();
define('API_KEY','326784961:AAFGsvaUNwh5UzHagDknfLYH4xvibyHfuSg'); // توکن ربات
//========= Functions ===========
...
$botusername = "PlayMusicsBot"; // یوزرنیم ربات بدون @
...
//========== Manage ===========
elseif($text == "مدیریت" or $text == "بازگشت به مدیریت" and $chat_id == $Dev){
